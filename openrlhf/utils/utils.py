...
def get_strategy(args):
    ...
    # Set gradient_accumulation_steps manually since it's not in the constructor
    strategy.gradient_accumulation_steps = getattr(args, "gradient_accumulation_steps", 1)
    return strategy
